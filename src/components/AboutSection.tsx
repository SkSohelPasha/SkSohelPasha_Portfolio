        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Shaik Sohel Pasha</span>, a Full Stack AI Engineer who turns complex problems into products with clarity, speed, and purpose. From polished React experiences and secure FastAPI services to RAG workflows powered by LangChain and Gemini, I build the complete system - not just the screen. I care about the details that make software feel reliable, useful, and ready for the real world.
            </motion.p>
